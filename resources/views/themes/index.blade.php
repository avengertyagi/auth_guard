...
<head>
    ...
    @stack('css-lib')
    <link rel="stylesheet" href="{{asset('assets/themes/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/themes/css/slick.css')}}" type="text/css" /> 
    <link rel="stylesheet" href="{{asset('assets/themes/css/templatemo-style.css')}}">
    @stack('style')
</head>
<body>
    <video autoplay muted loop id="bg-video">
        <source src="{{asset('assets/themes/video/gfp-astro-timelapse.mp4')}}" type="video/mp4">
    </video>
                ...
                <a class="navbar-brand" href="#">Astro Motion</a>
                  ...
                  <div class="collapse navbar-collapse" id="navbar-supported-content">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="btn btn-primary" href="{{ route('register') }}">Signup</a>
                      </li>
                    </ul>
                  </div>
              </nav>
            ...
            <div class="page-width-1 page-left">
              <div class="d-flex position-relative tm-border-top tm-border-bottom intro-container">
                ...
                <div class="intro-right">
                  <img src="{{asset('assets/themes/img/home-img-1.jpg')}}" alt="Image" class="img-fluid intro-img-1">
                  <img src="{{asset('assets/themes/img/home-img-2.jpg')}}" alt="Image" class="img-fluid intro-img-2">
                </div>
            ...
            <div class="mx-auto position-relative gallery-container">
              ...
              <div class="mx-auto tm-border-top gallery-slider">
                <figure class="effect-julia item">
                    <img src="{{asset('assets/themes/img/gallery-img-01.jpg')}}" alt="Image">
                    <figcaption>
                        <div>
                ...
                <figure class="effect-julia item">
                    <img src="{{asset('assets/themes/img/gallery-img-02.jpg')}}" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="{{asset('assets/themes/img/gallery-img-03.jpg')}}" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="{{asset('assets/themes/img/gallery-img-04.jpg')}}" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="{{asset('assets/themes/img/gallery-img-05.jpg')}}" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="{{asset('assets/themes/img/gallery-img-06.jpg')}}" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="{{asset('assets/themes/img/gallery-img-07.jpg')}}" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="{{asset('assets/themes/img/gallery-img-08.jpg')}}" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="{{asset('assets/themes/img/gallery-img-09.jpg')}}" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
  ...
  <script src="{{asset('assets/themes/js/bootstrap.min.js')}}"></script>
  <script src="{{asset('assets/themes/js/slick.js')}}"></script>
  <script src="{{asset('assets/themes/js/templatemo-script.js')}}"></script>
</body>
</html>